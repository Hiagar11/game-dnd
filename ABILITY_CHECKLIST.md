...
- [x] `taunt` — Провокация (active, 1AP, таунт 2 хода)
...
- [x] `cleave` — Раскол (active, 3AP, 2 соседние цели)

### ⚔️🏹 S ≥ 3 + A ≥ 3

- [x] `berserker_rage` — Ярость берсерка (active, 2AP, +50% урон / −20% уклон, 3 хода)
- [x] `charge` — Рывок (active, 3AP, прыжок 4 кл + удар)

### 🏹 A ≥ 5

- [x] `backstab` — Удар в спину (active, 2AP, телепорт за спину + d6+STR×2, требует невидимость)

### 🏹🔮 A ≥ 3 + I ≥ 3

- [x] `shadow_step` — Теневой шаг (active, 2AP, телепорт на любую клетку в радиусе 2)
- [x] `poison_blade` — Ядовитый клинок (active, 2AP, яд 3 хода)

### 🔮 I ≥ 5

- [x] `gravity_crush` — Грав. сжатие (active, 3AP, AoE радиус 2)
