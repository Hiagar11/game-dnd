...
export const BLOOD_BOLT = {
  ...
  description: 'Дальний магический удар: d8 + INT урона, кастер −2 HP.',
  icon: 'drop',
  color: '#dc2626',
  apCost: 2,
  type: 'active',
...
export const CLEAVE = {
  id: 'cleave',
  name: 'Раскол',
  description: 'Клин из 3 клеток вокруг тебя; направление задаётся курсором.',
  icon: 'axe-swing',
  color: '#ef4444',
  apCost: 3,
  type: 'active',
...
export const BERSERKER_RAGE = {
  ...
  description: '+50% урон, −20% уклонение, 3 хода. Расходует все AP.',
  icon: 'enrage',
  color: '#ef4444',
  apCost: 2,
...
export const CHARGE = {
  id: 'charge',
  name: 'Рывок',
  description: 'Прыжок до 4 клеток + удар (d6 + STR). Тратит MP по дистанции.',
  icon: 'charging-bull',
  color: '#ef4444',
  apCost: 3,
  type: 'active',
  ...
  delivery: 'melee',
  damageKind: 'physical',
  // Сама способность есть «подход» — auto-approach в click-handler не нужен,
  // иначе кастер пошагово подкрадётся до анимации рывка.
  requiresApproach: false,
  strengthScaling: 1,
  rangeCells: 4,
  tier: 2,
